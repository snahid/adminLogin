...
// var THREE = _interopRequireWildcard(require("https://cdn.skypack.dev/three@0.135.0"));

// var _postprocessing = require("https://cdn.skypack.dev/postprocessing");

// var _gsap = require("https://cdn.skypack.dev/gsap@3.8.0");
...
//     this.extMaterial.uniforms.uTime.value += this.time.delta * this.time.frequency; //this.mesh.rotation.y += 0.0001 * this.time.delta * data
...
//       this.height = window.innerHeight; // Update camera

//       this.camera.aspect = this.width / this.height;
//       this.camera.updateProjectionMatrix(); // Update renderer
...
//     position = [0, 0, 0]
//   }) {
//     const octa = new THREE.Mesh(this.octaGeometry, new THREE.MeshBasicMaterial({
//       wireframe: true,
//       color
//     }));
...
//       this.camera.add(listener); // create a global audio source

//       this.sound = new THREE.Audio(listener);
//       const audioLoader = new THREE.AudioLoader();
//       audioLoader.load("https://assets.codepen.io/74321/short-snow_01.mp3", buffer => {
//         this.sound.setBuffer(buffer);
//         this.sound.setLoop(false);
//         this.sound.setVolume(0.5);
//         this.sound.play();
//         this.analyser = new THREE.AudioAnalyser(this.sound, 32); // get the average frequency of the sound
...
//     this.composer.addPass(new _postprocessing.RenderPass(this.scene, this.camera));
//     this.composer.addPass(new _postprocessing.EffectPass(this.camera, new _postprocessing.BloomEffect({
//       blendFunction: _postprocessing.BlendFunction.SCREEN,
//       kernelSize: _postprocessing.KernelSize.MEDIUM,
